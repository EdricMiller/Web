...
```javascript
<input type="button" value="点我点我" onclick="alert('admin Hello 方式1')" />
```
...
<html lang="en">
  ...
  <body>
    <script type="text/javascript">
      // 在这里写 js 代码
      alert('admin hello 方式2');
      console.log('admin hello 方式2');
    </script>
  </body>
</html>
```
...
```js
console.log('admin1'); // 普通打印
console.warn('admin2'); // 警告打印
console.error('admin3'); // 错误打印
```
