...
path.extname('www.admin.com'); // 返回 '.com'
...
let arr1 = ['/foo1/foo2', 'admin', 'foo3'];
let result1 = path.resolve(...arr1);
console.log(result1); // 打印结果：/foo1/foo2/admin/foo3

let arr2 = ['/foo1/foo2', '/admin', 'foo3'];
let result2 = path.resolve(...arr2);
console.log(result2); // 打印结果：/admin/foo3
```
...
console.log(result1); // 返回：/Users/smyhvae/admin/app.js
