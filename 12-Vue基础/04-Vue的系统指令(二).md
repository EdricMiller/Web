...
<body>
    <h1 class="my-red my-thin">我是admin，admin</h1>
</body>
...
<body>
    <div id="app">
        ...
        <h1 :class="[flag?'my-active':'']">我是admin，admin</h1>
    </div>
...
<body>
    <div id="app">
        ...
        <h1 :class="[ {'my-active':flag} ]">我是admin，admin</h1>
    </div>
...
```html
        ...
        <h1 :class="{style1:true, style2:false}">我是admin，admin</h1>
```
...
<body>
    <div id="app">
        <!-- vue的写法4：直接使用对象-->
        <!-- 在为 class 使用 v-bind 绑定 对象的时候，对象的属性是类名。由于 对象的属性名可带引号，也可不带引号，所以 这里我没写引号；  属性的值 是一个标识符 -->
        <h1 :class="classObj">我是admin，admin</h1>
    </div>
...
```html
        <h1 :style="{color: 'red', 'font-size': '20px'}">我是admin，admin</h1>
```
...
<body>
    <div id="app">
        <h1 :style="styleObj">我是admin，admin</h1>
    </div>
...
<body>
    <div id="app">
        <h1 :style="[ styleObj1, styleObj2 ]">我是admin，admin</h1>
    </div>
