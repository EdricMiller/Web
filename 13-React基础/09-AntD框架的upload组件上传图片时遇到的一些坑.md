...
```json
    {
        ...
        "response": {
            "retCode": 0,
            "imgUrl": "http://admin.com/opfewfwj098902kpkpkkj976fe.jpg",
            "photoid": 271850
        }
    }
```
...
[
    {
        ...
        "response": {
            "retCode": 0,
            "msg": "success",
            "imgUrl": "http://admin.com/hfwpjouiurewnmbhepr689.jpg",
        }
    },
    {
        "uid": "rc-upload-1551084269812-5",
...
- [AntD框架的upload组件上传图片时使用customRequest方法自定义上传行为](https://www.cnblogs.com/admin/p/13093592.html)
